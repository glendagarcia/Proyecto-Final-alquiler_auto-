...
Public Class forminicio
    ...
    Private Sub FlotaToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles FlotaToolStripMenuItem.Click
        formflota.MdiParent = Me
        formflota.Show()
    End Sub

    Private Sub SucursalesToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles SucursalesToolStripMenuItem.Click
        formsucursal.MdiParent = Me
        formsucursal.Show()
    End Sub

    Private Sub RegistroDeAlquileresToolStripMenuItem_Click(sender As Object, e As EventArgs) Handles RegistroDeAlquileresToolStripMenuItem.Click
        formcliente.MdiParent = Me
        formcliente.Show()
    End Sub

    Private Sub RegistroDeAlquileresToolStripMenuItem1_Click(sender As Object, e As EventArgs) Handles RegistroDeAlquileresToolStripMenuItem1.Click
        fomralquiler.MdiParent = Me
        fomralquiler.Show()
    End Sub
End Class
